...
describe("Class Tests", () => {
  ...
  describe("SVG", () => {
    it("Testing setText method", () => {
      ...
      const userText = "MRR";
      const svg = new SVG();
      const test = `<text text-anchor="middle"x="100" y="150" fill="${textColor}" font-size=100 >${userText}</text>`;
    ...
    it("Testing render method", () => {
      ...
      const textColor = "Green";
      const userText = "MRR";
      const textTest = `<text text-anchor="middle"x="100" y="150" fill="${textColor}" font-size=100 >${userText}</text>`;
